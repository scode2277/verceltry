...
{/* 
This file is the source of truth for contributing guidelines.
It is automatically synced to /CONTRIBUTING.md during the build process (stripped of MDX-specific elements).
When making changes, only edit this file - the root CONTRIBUTING.md will be updated automatically.
*/}
